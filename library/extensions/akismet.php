...
class akismetExtension
	 ...
	 */
	public function init($runtime) {
		$this->blogURL = $_SERVER['HTTP_HOST'];
		$this->wordPressAPIKey = $runtime->config->extensions->akismet;
		...
		$this->comment['blog'] = $_SERVER['HTTP_HOST'];
